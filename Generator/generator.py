...
class Generator(object):
    ...
    def save_model(self, sess):
        self.saver.save(sess, 'save_Persuasion/ckpt/model4_roller_windows.ckpt')
        print("save model model4_roller_windows success!")

    def load_model(self, sess):
        self.saver.restore(sess, 'save_Persuasion/ckpt/model4_roller_windows.ckpt')
        print("save model model4_roller_windows success!")

    def load_this_model(self, sess, name):
        self.saver.restore(sess, name)
        print("save model "+name+" success!")
